...
<button class="snipcart-add-item"
  data-item-id="curso-excel-1"
  data-item-price="79.99"
  data-item-url="/paintings/starry-night"
  data-item-description="Curso Excel v1."
  data-item-image="/assets/images/starry-night.jpg"
  data-item-name="Curso Excel v1"
  data-item-custom1-name="Nivel"
  data-item-custom1-options="Básico|Medio[+100.00]|Avanzado[+300.00]">
  Comprar este curso
</button>
